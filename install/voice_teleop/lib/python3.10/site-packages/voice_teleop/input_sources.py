...
Each input source is just an iterator/callable that yields recognized
text strings. The control node doesn't care where the string came from,
so you can swap TextInputSource for MicrophoneInputSource later without
touching voice_commander_node.py.
"""
